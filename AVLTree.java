...
public class AVLTree implements Iterable<Integer> {
    ...
    protected ArrayDeque<Integer> step=new ArrayDeque<Integer>();
    protected ArrayDeque<ArrayDeque<Integer>> backtrack=new ArrayDeque<ArrayDeque<Integer>>();
	...
	protected Node insertNode(Node node, int value) {
        ...
        //push 1 for LL,2 for RR,3 for LR,4 for RL
        // Left Cases            
        if (balance > 1) {
        	step.push(1);
